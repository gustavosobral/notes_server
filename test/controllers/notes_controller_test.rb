...
class NotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create note' do
    assert_difference 'Note.count', 1 do
      post api_v1_notes_url, note: { title: 'My note',
                              body: 'Body content!',
                              status: 'draft',
  ...
  test 'should update note' do
    ...
    put api_v1_note_url(@note), note: { body: 'Body content updated!' }
    get api_v1_note_url(@note)
  ...
  test 'should not update first_seen' do
    ...
    put api_v1_note_url(@note), note: { first_seen: 1.month.ago }
    get api_v1_note_url(@note)
